  ...
  return (
    <div className="min-h-screen bg-background text-text relative overflow-x-hidden">
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-[20%] right-[-10%] w-[40vw] h-[40vw] rounded-full bg-accent/20 blur-[150px] animate-blob" style={{ animationDelay: '2s' }} />
        <div className="absolute bottom-[-20%] left-[20%] w-[60vw] h-[60vw] rounded-full bg-blue-600/10 blur-[150px] animate-blob" style={{ animationDelay: '4s' }} />
      </div>
      ...
      <header className="fixed top-0 left-0 w-full z-50 px-4 md:px-8 py-4">
        <div className="max-w-7xl mx-auto glass-panel rounded-2xl p-4 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <motion.div 
            ...
            className="w-full md:w-auto flex-1 max-w-2xl"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 pt-40 pb-20 relative z-10">
        ...
        <main>
          <PokemonDetails pokemonName={selectedPokemon} onSelectPokemon={handleSelectPokemon} />
        </main>
      </div>
    </div>
  );
